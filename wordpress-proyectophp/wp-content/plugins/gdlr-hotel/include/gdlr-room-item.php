<?php
	...
	*/
	...
	if( !function_exists('gdlr_get_medium_room') ){
		function gdlr_get_medium_room($query, $thumbnail_size){
			$ret  = '';
			while($query->have_posts()){ $query->the_post();
				...
				$ret .= '<a class="gdlr-button with-border" href="' . get_permalink() . '">' . __('Ver Detalles', 'gdlr-hotel') . '<i class="fa fa-long-arrow-right icon-long-arrow-right"></i></a>';
	...
	if( !function_exists('gdlr_get_classic_room') ){
		function gdlr_get_classic_room($query, $size, $thumbnail_size){
			...
			while($query->have_posts()){ $query->the_post();
				...
				$ret .= '<a class="gdlr-button with-border" href="' . get_permalink() . '">' . __('Revisar detalles', 'gdlr-hotel') . '<i class="fa fa-long-arrow-right icon-long-arrow-right"></i></a>';
				$ret .= '</div>'; // gdlr-ux
				$ret .= '</div>'; // gdlr-item
				$ret .= '</div>'; // gdlr-column-class
				$current_size ++;
	...
	if( !function_exists('gdlr_get_modern_room') ){
		function gdlr_get_modern_room($query, $size, $thumbnail_size){
			...
			while($query->have_posts()){ $query->the_post();
				...
				$ret .= '<div class="gdlr-room-thumbnail">' . gdlr_get_room_thumbnail($post_option, $thumbnail_size) . '</div>';
				$ret .= '<h3 class="gdlr-room-title"><a href="' . get_permalink() . '" >' . get_the_title() . '</a></h3>';
				$ret .= '<a href="' . get_permalink() . '" class="gdlr-room-detail">' . __('Ver Detalles', 'gdlr-hotel') . '<i class="fa fa-long-arrow-right icon-long-arrow-right"></i></a>';
				$ret .= '</div>'; // gdlr-ux
				$ret .= '</div>'; // gdlr-item
				$ret .= '</div>'; // gdlr-column-class
				$current_size ++;
	...
	if( !function_exists('gdlr_hotel_room_info_new') ){
		function gdlr_hotel_room_info_new( $options = array(), $list = array(), $wrapper = true ){
			...
			foreach( $options as $option ){
				$ret .= '<div class="gdlr-room-info" style="background-color: #800880;">';
			...
			if( $wrapper && !empty($ret) ){
				$ret = '<div style="background-color:#800880;" class="gdlr-hotel-room-info">' . $ret . '<div class="clear"></div></div>';
			}
			return $ret;
		}
	}
				...
				switch( $slug ){
					...
					case 'price-break-down': 
						if( !empty($post_option['room-base-price']) ){
							...
							if( $slug == 'price' || empty($hotel_option['booking-price-display']) || $hotel_option['booking-price-display'] == 'start-from' ){
								$ret .= '<span class="gdlr-head">' . __('Empieza desde', 'gdlr-hotel') . '</span>';
								$ret .= '<span class="gdlr-tail">' . gdlr_hotel_money_format($post_option['room-base-price']) . ' / ' . __('Noche', 'gdlr-hotel') . '</span>';
							}else{
							...
							if( $slug == 'price-break-down' ){
								...
								$ret .= '<div class="gdlr-price-break-down" >' . __('* vista previa del precio', 'gdlr-hotel');
					...
					case 'bed': 
						if( !empty($post_option[$slug]) ){
							...
							$ret .= '<i class="fa fa-check-square-o icon-check" ></i>';
							$ret .= '<span class="gdlr-head">' . __('Camas', 'gdlr-hotel') . '</span>';
					...
					case 'max-people':  
						if( !empty($post_option[$slug]) ){
							$ret .= '<div class="gdlr-room-info">';
							$ret .= '<i class="fa fa-check-square-o icon-check" ></i>';
							$ret .= '<span class="gdlr-head">' . __('Maximas', 'gdlr-hotel') . '</span>';
							$ret .= '<span class="gdlr-tail">' . $post_option[$slug] . ' ' . __('Personas', 'gdlr-hotel') . '</span>';
							$ret .= '</div>';
						}
						break;
					case 'view':  
						if( !empty($post_option[$slug]) ){
							$ret .= '<div class="gdlr-room-info">';
							$ret .= '<i class="fa fa-check-square-o icon-check" ></i>';
							$ret .= '<span class="gdlr-head">' . __('Vista', 'gdlr-hotel') . '</span>';
							$ret .= '<span class="gdlr-tail">' . $post_option[$slug] . '</span>';
							$ret .= '</div>';
						}
						break;
					case 'room-size':   
						if( !empty($post_option[$slug]) ){
							$ret .= '<div class="gdlr-room-info">';
							$ret .= '<i class="fa fa-check-square-o icon-check" ></i>';
							$ret .= '<span class="gdlr-head">' . __('Tamaño de habitación', 'gdlr-hotel') . '</span>';
							$ret .= '<span class="gdlr-tail">' . $post_option[$slug] . '</span>';
							$ret .= '</div>';
						}
						break;
					...
					case 'breakfast-included':  
						if( !empty($post_option[$slug]) ){
							$ret .= '<div class="gdlr-room-info">';
							$ret .= '<i class="fa fa-check-square-o icon-check" ></i>';
							$ret .= '<span class="gdlr-head">' . __('Desayuno incluido', 'gdlr-hotel') . '</span>';
							$ret .= '<span class="gdlr-tail">' . $post_option[$slug] . '</span>';
							$ret .= '</div>';
						}
						break;
					case 'room-service':   
						if( !empty($post_option[$slug]) ){
							$ret .= '<div class="gdlr-room-info">';
							$ret .= '<i class="fa fa-check-square-o icon-check" ></i>';
							$ret .= '<span class="gdlr-head">' . __('Servicios de habitación', 'gdlr-hotel') . '</span>';
							$ret .= '<span class="gdlr-tail">' . $post_option[$slug] . '</span>';
							$ret .= '</div>';
						}
						break;
					case 'airport-pickup-service':  
						if( !empty($post_option[$slug]) ){
							$ret .= '<div class="gdlr-room-info">';
							$ret .= '<i class="fa fa-check-square-o icon-check" ></i>';
							$ret .= '<span class="gdlr-head">' . __('Servicio de Aeropuerto', 'gdlr-hotel') . '</span>';
							$ret .= '<span class="gdlr-tail">' . $post_option[$slug] . '</span>';
							$ret .= '</div>';
						}
						break;
