	...
	*/	
	...
	if( !function_exists('get_price_breakdown_popup') ){
		function get_price_breakdown_popup($post_option){
			...
			$weekday_title  = '<span>x ' . $price['weekday-night'] . ' ' . __('Noche', 'gdlr-hotel') . (($price['weekday-night']>1)? 's': '');
			$weekday_title .= ' ' . __('(Entre semana)', 'gdlr-hotel') . '</span>';
			$weekend_title  = '<span>x ' . $price['weekend-night'] . ' ' . __('Noche', 'gdlr-hotel') . (($price['weekday-night']>1)? 's': '');
			$weekend_title .= ' ' . __('(Fin de semana)', 'gdlr-hotel') . '</span>';				
			
			$ss_weekday_title  = '<span>x ' . $price['ss_weekday-night'] . ' ' . __('Noche', 'gdlr-hotel') . (($price['ss_weekday-night']>1)? 's': '');
			$ss_weekday_title .= ' ' . __('(Entre semana)', 'gdlr-hotel') . '</span>';
			$ss_weekend_title  = '<span>x ' . $price['ss_weekend-night'] . ' ' . __('Noche', 'gdlr-hotel') . (($price['ss_weekday-night']>1)? 's': '');
			$ss_weekend_title .= ' ' . __('(Fin de semana)', 'gdlr-hotel') . '</span>';			
			...
			$price_title = array(
				...
				'adult'=> $price['adult-num'] . ' ' . __('Adultos', 'gdlr-hotel') . $weekday_title,
				'adult-weekend'=> $price['adult-num'] . ' ' . __('Adultos', 'gdlr-hotel') . $weekend_title,
				...
				'child'=> $price['child-num'] . ' ' . __('Niños', 'gdlr-hotel') . $weekday_title,
			...
			$ret .= '<span class="">' . __('*', 'gdlr-hotel') . '</span>';
			$ret .= '</span>';
