	...
	if( !function_exists('gdlr_generate_style_custom') ){
		function gdlr_generate_style_custom( $options ){ 
			...
			foreach($skins as $skin){
				...
				$style .= 'border-color: ' . $skin['button-border'] . '; color: ' . $skin['button-text'] . '; background-color: ' . $skin['button-background'] . ';  }' . "\n";
								...
								'search-archive-style' => array(
									...
									'options' => array(
										...
										'archive-room-size'=> array(
											'title'=> __('Habitacion Size' ,'gdlr_translate'),
											'type'=> 'combobox',
											'options'=> array(
												'4'=>'1/4',
												'3'=>'1/3',
											...
											'default'=>'3',
											'wrapper-class'=> 'classic-wrapper modern-wrapper archive-room-style-wrapper'
										),	
										'archive-room-num-excerpt'=> array(
											'title'=> __('Room Num Excerpt (Word)' ,'gdlr_translate'),
											'type'=> 'text',	
											'default'=> '25',
											'wrapper-class'=> 'medium-wrapper archive-room-style-wrapper',
											'description'=> __('This is a number of word (decided by spaces) that you want to show on the post excerpt. <strong>Use 0 to hide the excerpt, -1 to show full posts and use the wordpress more tag</strong>.', 'gdlr_translate')
										),
								...
								'top-bar-color' => array(
									...
									'options' => array(			
										...
										'main-navigation-text-hover-divider' => array(
											...
											'type' => 'colorpicker',
											'default' => '#aa8667',
											'selector'=> '.gdlr-navigation-gimmick{ background-color: #gdlr#; }'
										),										
										...
										'transparent-main-navigation-text-hover' => array(
											...
											'selector'=> '.gdlr-header-transparent .gdlr-main-menu > li:hover > a, ' . 
												...
												'.gdlr-header-transparent div#gdlr-navigation-gimmick { background-color: #gdlr#; }'
										),
									)
								),		
								...
								'datepicker-color' => array(
									...
									'options' => array(
										...
										'booking-process-background' => array(
											'title' => __('Booking Process Background', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#967f63',
										...
										'booking-process-border' => array(
											...
											'type' => 'colorpicker',
											'default' => '#b4a38f',
											'selector'=> '.gdlr-booking-process-bar .gdlr-booking-process:before{ border-left-color: #gdlr#; }'
										),
									)
								),
								...
								'reservation-bar' => array(
									...
									'options' => array(
										...
										'reservation-bar-header-text' => array(
											...
											'type' => 'colorpicker',
											'default' => '#ffffff',
											'selector'=> '.gdlr-reservation-bar .gdlr-reservation-bar-title, .gdlr-reservation-bar .gdlr-reservation-field-title, ' .
												'.gdlr-reservation-people-title { color: #gdlr#; }'
										),
										...
										'reservation-bar-room-section-active-text' => array(
											...
											'type' => 'colorpicker',
											'default' => '#ffffff',
											'selector'=> '.gdlr-reservation-room.gdlr-active{ color: #gdlr#; }'
										),
