		...
		class gdlr_admin_option_html{
			...
			function print_ssp_option($settings = array()){
				...
				if( $settings['room-type'] == 'hostel' ){
					...
					echo '<div class="four columns"><div class="gdlr-ssp-title">' . __('Niños Price', 'gdlr_translate') . '</div><input type="text" data-slug="cpwe" /></div>';
					...
					echo '<div class="four columns"><div class="gdlr-ssp-title">' . __('Niños Price', 'gdlr_translate') . '</div><input type="text" data-slug="cpwd" /></div>';
			...
			function print_fas_option($settings = array()){
				...
				if( isset($settings['value']) ){
					...
					if( !empty($settings['data-type']) && $settings['data-type'] == 'hostel' ){
						...
						$default = array(
							array('title'=>__('Camas' , 'gdlr-hotel'), 'value'=> (empty($option_value['bed'])?'': $option_value['bed'])),
							array('title'=>__('Maximo de Personas' , 'gdlr-hotel'), 'value'=> (empty($option_value['max-people'])?'': $option_value['max-people'])),
							array('title'=>__('Vista' , 'gdlr-hotel'), 'value'=> (empty($option_value['view'])?'': $option_value['view'])),
							array('title'=>__('Tamaño' , 'gdlr-hotel'), 'value'=> (empty($option_value['room-size'])?'': $option_value['room-size'])),
							array('title'=>__('Wifi' , 'gdlr-hotel'), 'value'=> (empty($option_value['wifi'])?'': $option_value['wifi'])),
							array('title'=>__('Desayuno' , 'gdlr-hotel'), 'value'=> (empty($option_value['breakfast-included'])?'': $option_value['breakfast-included'])),
							array('title'=>__('Servicios de habitación' , 'gdlr-hotel'), 'value'=> (empty($option_value['room-service'])?'': $option_value['room-service'])),
							array('title'=>__('Servicio de Areopuerto' , 'gdlr-hotel'), 'value'=> (empty($option_value['airport-pickup-service'])?'': $option_value['airport-pickup-service']))
						);
					}
					echo esc_textarea(json_encode($default));
				}
